...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.singlePlayer.on('pointerover',function(pointer){
      this.singlePlayerBorder.visible = true;
    },this)
    
    this.singlePlayer.on('pointerout',function(pointer){
      this.singlePlayerBorder.visible = false;
    },this)
    ...
    this.multiplayer.on('pointerover',function(pointer){
      this.multiplayerBorder.visible = true;
    },this)
    
    this.multiplayer.on('pointerout',function(pointer){
      this.multiplayerBorder.visible = false;
    },this)
    ...
    this.howToPlay.on('pointerover',function(pointer){
      this.howToPlayBorder.visible = true;
    },this)
    
    this.howToPlay.on('pointerout',function(pointer){
      this.howToPlayBorder.visible = false;
    },this)
    ...
    this.about.on('pointerover',function(pointer){
      this.aboutBorder.visible = true;
    },this)
    
    this.about.on('pointerout',function(pointer){
      this.aboutBorder.visible = false;
    },this)
